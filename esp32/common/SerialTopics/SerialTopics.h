...
#define SUBSCRIBE_OPCODE (SERIALSERIALTALKS_RESEVED_OPCODE_7)
#define UNSUBSCRIBE_OPCODE (SERIALSERIALTALKS_RESEVED_OPCODE_8)
#define GET_CONTEXT_OPCODE (SERIALSERIALTALKS_RESEVED_OPCODE_9)
