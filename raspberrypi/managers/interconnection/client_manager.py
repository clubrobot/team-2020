    ...
    def try_connect(self):
        ...
        while not connected:
            try:
                ...
                self.logger("CLIENT MANAGER[{}] : ".format(
                    self.clientname), "Connected")
                connected = True
            except Exception as e:
                self.logger("CLIENT MANAGER[{}] : ".format(
                    self.clientname), "Not connected" + str(e))
                pass
